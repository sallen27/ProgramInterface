...
public class LightController {
	...
	Map<String, Color> colorMap = new HashMap<String, Color>() {{
		...
		put("pink", Color.PINK);
		put("red", Color.RED);
		put("light blue", new Color(18, 137, 188));
		put("blue", new Color(45, 49, 255));
		put("orange", new Color(255, 180, 0));
		put("green", Color.GREEN);
		put("light yellow", new Color(250, 252, 108));
		put("yellow", new Color(255, 228, 28));
		put("light purple", new Color(232, 154, 237));
		put("purple", new Color(203, 84, 255));
...
//        List<PHLight> allLights = cache.getAllLights();
	...
	public void turnOffAllLights(List<PHLight> lights) {
		PHBridge bridge = sdk.getSelectedBridge();
	...
	public Map<String, Color> getColorOptions(){
		return colorMap;
	}
	
	public void dimLights(ArrayList<PHLight> lights){
